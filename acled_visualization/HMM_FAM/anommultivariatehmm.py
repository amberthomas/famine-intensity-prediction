...
anomdata = np.vstack((anom_13_avg, anom_14_avg, anom_15_avg, anom_16_avg))
anomdata1 = np.vstack((anom_13_avg, anom_14_avg, anom_15_avg, anom_16_avg, anom_17_avg))
...
inputs = np.dstack((year,ndvi,anom))
inputs1 = np.dstack((year1,ndvi1,anom1))

inputs = np.reshape(inputs,(32,4,3))
inputs1 = np.reshape(inputs1,(32,5,3))

model = HiddenMarkovModel.from_samples(MultivariateGaussianDistribution, n_components=19, X=inputs ,algorithm='baum-welch', verbose=False, emission_pseudocount=0.5, end_state=False)
count = 0
output_diagnol = []
dictionary = {}
temps = 0
...
anom_12_avg = (frame.anom_12_avg)
anom_12_2_avg = (frame.anom_12_2_avg)
anom_13_avg = (frame.anom_13_avg)
anom_13_2_avg = (frame.anom_13_2_avg)
anom_14_avg = (frame.anom_14_avg)
anom_14_2_avg = (frame.anom_14_2_avg)
anom_15_avg = (frame.anom_15_avg)
...
anom_18_avg = (frame.anom_18_avg)


#ndvidata = np.vstack((ndvi2014,ndvi2015_1,ndvi2015,ndvi2016_1,ndvi2016,ndvi2017_1))
#ndvidata1 = np.vstack((ndvi2014,ndvi2015_1,ndvi2015,ndvi2016_1,ndvi2016,ndvi2017_1,ndvi2017))

anomdata = np.vstack((anom_12_avg, anom_12_2_avg, anom_13_avg, anom_13_2_avg, anom_14_avg, anom_14_2_avg, anom_15_avg, anom_15_2_avg, anom_16_avg, anom_16_2_avg, anom_17_avg, anom_17_2_avg))
anomdata1 = np.vstack((anom_12_avg, anom_12_2_avg, anom_13_avg, anom_13_2_avg, anom_14_avg, anom_14_2_avg, anom_15_avg, anom_15_2_avg, anom_16_avg, anom_16_2_avg, anom_17_avg, anom_17_2_avg, anom_18_avg))
...
inputs = np.reshape(inputs,(56,12,3))
inputs1 = np.reshape(inputs1,(56,13,3))
...
anomdata = np.vstack((anom_13_avg,anom_14_avg, anom_15_avg, anom_15_2_avg, anom_16_avg, anom_16_2_avg, anom_17_avg, anom_17_2_avg))
anomdata1 = np.vstack((anom_13_avg,anom_14_avg, anom_15_avg, anom_15_2_avg, anom_16_avg, anom_16_2_avg, anom_17_avg, anom_17_2_avg, anom_18_avg))
...
inputs = np.reshape(inputs,(49,8,3))
inputs1 = np.reshape(inputs1,(49,9,3))

model = HiddenMarkovModel.from_samples(MultivariateGaussianDistribution, n_components=20, X=inputs ,algorithm='baum-welch', verbose=False, emission_pseudocount=0.5, end_state=False)
count = 0
output_diagnol = []
dictionary = {}
temps = 0
...
print("accuracy_prob for Mali is")
print(counter_prob)
print(counter_prob/49)

print("classwise accuracies for Mali are")
print("Class 0")
print(class0/49)
print("Class 1")
print(class1/49)
...
ndvidata = np.vstack((ndvi_14,ndvi_15,ndvi_15_2,ndvi_16,ndvi_16_2,ndvi_17,ndvi_17_2))
ndvidata1 = np.vstack((ndvi_14,ndvi_15,ndvi_15_2,ndvi_16,ndvi_16_2,ndvi_17,ndvi_17_2,ndvi_18))

anomdata = np.vstack((anom_14_avg, anom_15_avg, anom_15_2_avg, anom_16_avg, anom_16_2_avg, anom_17_avg, anom_17_2_avg))
anomdata1 = np.vstack((anom_14_avg, anom_15_avg, anom_15_2_avg, anom_16_avg, anom_16_2_avg, anom_17_avg, anom_17_2_avg, anom_18_avg))
...
inputs = np.reshape(inputs,(74,7,3))
inputs1 = np.reshape(inputs1,(74,8,3))

model = HiddenMarkovModel.from_samples(MultivariateGaussianDistribution, n_components=17, X=inputs ,algorithm='baum-welch', verbose=False, emission_pseudocount=0.5, end_state=False)
count = 0
output_diagnol = []
dictionary = {}
temps = 0
...
anomdata = np.vstack((anom_14_avg, anom_15_avg, anom_15_2_avg, anom_16_avg, anom_16_2_avg, anom_17_avg))
anomdata1 = np.vstack((anom_14_avg, anom_15_avg, anom_15_2_avg, anom_16_avg, anom_16_2_avg, anom_17_avg, anom_17_2_avg))
...
inputs = np.reshape(inputs,(48,6,3))
inputs1 = np.reshape(inputs1,(48,7,3))

model = HiddenMarkovModel.from_samples(MultivariateGaussianDistribution, n_components=15, X=inputs ,algorithm='baum-welch', verbose=False, emission_pseudocount=1, end_state=False)
count = 0
output_diagnol = []
dictionary = {}
temps = 0
